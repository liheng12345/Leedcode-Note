...
![image-20211229104230566](fig/image-20211229104230566.png)
...
![image-20211229090703799](fig/image-20211229090703799.png)
...
![image-20211209094903138](fig/image-20211209094903138.png)
...
![image-20211209104121689](fig/image-20211209104121689.png)
...
![image-20211209145202515](fig/image-20211209145202515.png)
...
![image-20211210100605071](fig/image-20211210100605071.png)
...
![image-20211213103036586](fig/image-20211213103036586.png)

#### 只出现一次的数字II

![image-20211213105922609](fig/image-20211213105922609.png)

![image-20211213105934832](fig/image-20211213105934832.png)

![image-20211213105949115](fig/image-20211213105949115.png)

#### 两数相除

![image-20211213115132847](fig/image-20211213115132847.png)

![image-20211213115148216](fig/image-20211213115148216.png)

![image-20211213115159451](fig/image-20211213115159451.png)

#### 颠倒二进制位

![image-20211213160128127](fig/image-20211213160128127.png)

![image-20211213160135811](fig/image-20211213160135811.png)

#### 数字范围按位与

这里用暴力求解也可以过

但是这个题没必要枚举所有的数字，**只需要求两端的公共前缀就好了**

![image-20211213163537311](fig/image-20211213163537311.png)

![image-20211213163712586](fig/image-20211213163712586.png)

### 贪心策略

#### 最大数

思路就是比较相邻两个数据x，y，看怎么拼接值更大，调整顺序。

举例：10，2，102 < 210 所以需要调整10，2的顺序。

![image-20211213153309875](fig/image-20211213153309875.png)

![image-20211213153552101](fig/image-20211213153552101.png)
...
思路：把判断为质数的数全部都置换为非质数。

![image-20211213170450048](fig/image-20211213170450048.png)

![image-20211213170458991](fig/image-20211213170458991.png)
